...
export function CardForm({
  ...
  return (
    <Modal open={open} onClose={onClose} title={editCard ? 'Edit Card' : 'Add Card'} maxWidth="max-w-5xl">
      <form onSubmit={handleSave} className="mt-2 flex flex-col gap-5">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="flex-1">
            <label className={labelClass}>
              Title{' '}
              <span className="text-surface-400 font-normal text-xs">(front of card)</span>
            </label>
            <input
              type="text"
        ...
        {/* Row 2: Content fills full width */}
        <div>
          <label className={labelClass}>
            Content{' '}
            <span className="text-surface-400 font-normal text-xs">(back of card)</span>
          </label>
          <MarkdownEditor
            value={content}
            onChange={setContent}
        ...
        <div className="sticky bottom-0 flex justify-end gap-3 pt-4 mt-4 border-t border-surface-200 dark:border-surface-700 bg-surface-0 dark:bg-surface-800 -mx-6 px-6 pb-6">
